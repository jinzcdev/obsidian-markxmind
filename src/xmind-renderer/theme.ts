...
export const darkTheme = {
  ...
  map: {
    ...
    properties: {
      'svg:fill': '#121212',
      'multi-line-colors': '#FF6B6B #FFAA5A #FFD166 #06D6A0 #73A5FF #9B7AFF',
      'color-list': '#4E79A7 #59A14F #EDC948 #B07AA1 #76B7B2 #FF9DA7',
      'line-tapered': 'none',
    },
  },
  importantTopic: {
  ...
  minorTopic: {
    ...
    properties: {
      'svg:fill': '#4a4a2a',
      'fill-pattern': 'solid',
      'border-line-color': '#9e9a5c',
      'fo:color': '#e0e0e0',
    },
  },
  colorThemeId: 'Dark-Theme-Pro',
  expiredTopic: {
    id: 'c2afd293-7843-4ca4-b01f-4353768628ea',
    properties: {
      'fo:text-decoration': 'line-through',
